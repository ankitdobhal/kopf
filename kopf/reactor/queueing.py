...
async def watcher(
    ...
    resource_listed: Optional[primitives.Toggle]
        ...
        async for raw_event in stream:
            ...
            if raw_event is watching.Bookmark.LISTED:
                if operator_indexed is not None and resource_listed is not None:
                    ...
                    await operator_indexed.drop_toggle(resource_listed)  # save RAM
            ...
            try:
                ...
                resource_indexed: Optional[primitives.Toggle]
